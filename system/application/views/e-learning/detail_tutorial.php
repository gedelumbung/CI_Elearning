...
echo"<br>Tutorial ini dibaca sebanyak<b> ".$rows['counter']." kali</b><br><span class='berita-lain'><img src='".base_url()."system/application/views/e-learning/images/icon-berita.png'>Baca Juga Tutorial Lainnya</span>";
echo"<ul>";
